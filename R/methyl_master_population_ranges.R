...
#'
#' modified by Michael Mariani @Dartmouth College 08/16/2021
#' date: 08/17/2021
#'   modified .approxP() function to .approxP.mm()
#'  and replaced its call in the .estimateRecurrence()
#'   function to handle cases where we only have "losses"
#'   instead of the usual "both", "gains", "losses"
#'
